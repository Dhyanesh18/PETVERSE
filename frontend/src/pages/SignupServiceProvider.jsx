...
const SignupServiceProvider = () => {
    ...
    const [fileName, setFileName] = useState('Upload your certificate');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await api.post('/auth/signup/service-provider', formDataToSend, {
            ...
            <div className="w-full max-w-4xl bg-white shadow-[0_12px_30px_rgba(0,0,0,0.2)] rounded-2xl p-8 my-2">
                ...
                <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="text-center">
                        <h2 className="text-gray-800 text-3xl font-semibold mb-2">Service Provider Registration</h2>
                        <p className="text-gray-600 text-sm">Create your service provider account to offer services on PetVerse</p>
                    </div>
                </div>
                    ...
                    <div className="flex justify-between gap-5">
                        ...
                        <div className="w-1/2">
                            ...
                            <div className="relative mt-12 mb-4">
                                <label className="absolute -top-2.5 left-2.5 bg-white px-1.5 text-sm text-gray-600 z-10">
                                ...
                                <select
                                    ...
                                    onBlur={handleBlur}
                                    required
                                    className="w-full px-4 py-3 pt-4 border-2 border-gray-300 rounded-lg text-sm transition-all bg-gray-50 focus:bg-white focus:border-teal-500 focus:shadow-[0_0_8px_rgba(95,158,160,0.1)] focus:outline-none appearance-none"
                                >
                                ...
                                {touched.serviceType && errors.serviceType && (
                                    <span className="absolute -bottom-5 left-0 text-red-500 text-xs">{errors.serviceType}</span>
                                )}
                            </div>
                            ...
                            <div className="mt-6 mb-4">
                                <div className="relative border-2 border-gray-300 rounded-lg p-3 bg-gray-50 hover:border-teal-500 transition-all cursor-pointer">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-teal-600 font-medium">Certificate</span>
                                    </div>
                                </div>
                                {errors.certificate && (
                                    <span className="text-red-500 text-xs mt-1">{errors.certificate}</span>
                                )}
                            </div>
                        </div>
