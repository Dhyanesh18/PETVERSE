...
import { FaWallet, FaPlus, FaMinus, FaHistory, FaArrowLeft, FaRupeeSign, FaCreditCard, FaMobile } from 'react-icons/fa';
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-gray-800 capitalize">
                                                        {transaction.type ? transaction.type.replace(/_/g, ' ') : 'Transaction'}
                                                    </h4>
