...
const AddPet = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('/api/seller/pets', {
                method: 'POST',
                credentials: 'include',
                body: formDataToSend
            });
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        style={{ fontSize: '16px' }}
                                    />
                                    {formData.breed && !validationErrors.breed && (
                                        <i className="fas fa-check-circle absolute right-3 top-1/2 transform -translate-y-1/2 text-green-500"></i>
                                    )}
                                </div>
                                {validationErrors.breed && (
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        style={{ fontSize: '16px' }}
                                    />
                                    {formData.age && !validationErrors.age && (
                                        <i className="fas fa-check-circle absolute right-3 top-1/2 transform -translate-y-1/2 text-green-500"></i>
                                    )}
                                </div>
                                {validationErrors.age && (
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        onChange={handleInputChange}
                                        required
                                        className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-teal-500 transition-all duration-200 cursor-pointer"
                                        style={{ fontSize: '16px' }}
                                    >
                        ...
                        <div className="mt-8">
                            ...
                            <div className="relative">
                                <textarea
                                    ...
                                    rows="4"
                                    maxLength="500"
                                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-teal-500 transition-all duration-200 resize-vertical"
                                    placeholder="Describe your pet's personality, training, health, or any special characteristics..."
                                ...
                                <div className={`border-2 border-dashed rounded-lg p-8 text-center transition-all duration-200 ${
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <p className="text-lg font-medium text-gray-700 mb-1">
                                            {images.length > 0 ? `${images.length} image(s) selected` : 'Click to upload pet images'}
                                        </p>
